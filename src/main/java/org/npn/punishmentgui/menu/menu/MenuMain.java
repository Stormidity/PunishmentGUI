...
public abstract class MenuMain {
    ...
    public void open(Player player) {
        MenuMain previous = plugin.getMenuManager().getOpenedMenus().get(player.getUniqueId());
        if (previous != null) {
    ...
    public void update(Player player) {
        ...
        MenuMain currentlyOpenedMenu = plugin.getMenuManager().getOpenedMenus().get(player.getUniqueId());
